...
class NotesController extends Controller
{
    ...
    public function adminindex()
    {
        ...
        return view ('super-admin.notes.index')->with('data', $notes);
        // dd($notes);
        // echo $notes->notes;
    }
    ...
    public function create(): View
    {
        ...
        return view('super-admin.notes.create')->with('data',$subjects);
    }
    ...
    {
        $notes = Notes::find($id);
        return view('super-admin.notes.show')->with('notes', $notes);
    }
    public function edit(string $id): View
    {
        $notes = Notes::find($id);
        return view('super-admin.notes.edit')->with('notes', $notes);
    }
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        return redirect('super-admin/dashboard')->with('flash_message', 'Notes Updated!');  
    }
    public function destroy(string $id): RedirectResponse
    {
        $data = Notes::find($id);
        $file_path1 = app_path().$data->pyq1;
