                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <iframe height="400" width="400"
                                                src="/assets/folder/{{ $data->pyq1 }}"></iframe>
                                            ...
                                            This browser does not support PDFs. Please download the PDF to view it: <a
                                                href="/assets/folder/{{ $data->pyq1 }}">Download PDF</a>
                                            {{-- </iframe> --}}
                                        </td>
                                        {{-- </div> --}}
                                        {{-- <td>{{ $data->pyq1 }}</td> --}}
                                        ...
                                        <td>
                                            <iframe height="400" width="400"
                                                src="/assets/folder/{{ $data->pyq2 }}"></iframe>
                                        </td>
                                        <td>
                                            <iframe height="400" width="400"
                                                src="/assets/folder/{{ $data->pyq3 }}"></iframe>
                                        </td>
                                        <td>
                                            <iframe height="400" width="400"
                                                src="/assets/folder/{{ $data->notes }}"></iframe>
                                        </td>
                                        {{-- <td>{{ $data->pyq3 }}</td> --}}
