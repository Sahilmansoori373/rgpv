        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="why-box">
              ...
              <p>
                  "Access our comprehensive notes, completely free! Explore a vast collection covering various subjects and topics, meticulously crafted to aid your learning journey. With no subscription fees or hidden costs, ! There is no mandatory fee for the students, they can freely use most of our services without paying even a single rupee to us."
              </p>
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p>"You don't have to register for most of the services we provide. Mostly everything is available freely for the students without any condition or restriction."</p>
                </div>
              </div><!-- End Icon Box -->
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p>
                    We try our best for providing the best possible user experience to our users. All of our web and mobile apps are built with the mobile-first approach in mind.
                  </p>
                </div>
              </div><!-- End Icon Box -->
